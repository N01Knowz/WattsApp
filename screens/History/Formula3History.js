...
const Formula3History = () => {
  ...
  const getData = async () => {
    try {
      variable = await fetchData("formula3");
      setDatas(variable);
    } catch (error) {
  ...
  return (
    <ScrollView style={styles.main}>
      ...
      >
        ...
        <Text style={styles.modalContentText}>Voltage: {showData.Days}</Text>
        <Text style={styles.modalContentText}>Watt: {showData.Saved}</Text>
        <Text style={styles.modalContentText}>Watt-Hour: {showData.W}</Text>
        <Text style={styles.modalContentText}>Hour: {showData.hrs}</Text>
...
export default Formula3History;
